            ...
            <div class="col-lg-6 col-md-11 checkoutLogo ">
                <a href="index-2.php">
                    ...
                    <p class="checkoutText">
                        ...
                        <span class="checkoutActive">Information</span>
                        <i class="fa fa-angle-right checkoutLeftArrow" aria-hidden="true"></i>
                        <a href="shipping.php"><span class="checkoutNotActive">Shipping</span></a>
                        <i class="fa fa-angle-right checkoutLeftArrow" aria-hidden="true"></i>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-12 paddingright5Shipping">
            <div class="row">
                <div class="col-12 marginbottom10">
                    <span class="contactText">Contact information</span>
                    <span class="accountText">Already have an account? <a class="accountLoginText" href="login.php">Log in</a></span>
                </div>
            </div>
            <div class="col-md-12 pleftright0">
            ...
            <div class="row">
                <div class="col-md-12 margintop10">
                    ...
                    <label for="checkbox1" class="input-helper input-helper--checkbox3 keepText">Keep me up to date on
                    news and exclusive offers</label>
                </div>
            </div>
            <p class="shipAddressText">Shipping address</p>
            <form action="#">
                <div class="row marginbottom10">
                    <div class="col-md-6">
                        <div class="form-contents">
                            <div class="fc">
                                <input class="marginbottom10v2" type="text" value="" required/>
                ...
                <div class="row returnRow">
                    ...
                    <div class="col-md-7 col-12">
                        <a href="#">
                            <button class="continueBtn">Continue to shipping</button>
                        </a>
                    </div>
                </div>
            </form>
